...
public class VolumeProcessor implements Runnable {
	...
	private int maxDimWidth, minDimWidth;
	private int totalLevels;
	private int totalBricks;

	private int currentSliceIndx = -1;
...
//	}
	...
	public void setSliceIdx(int slice) {
		if (slice < yWidth)
			currentSliceIndx = slice;
	}

	public int getSliceIdx() {
		return currentSliceIndx;
	}
...
//				sliceProcessor.setThreshold((isnt)mean);
//			}
//
//		} catch (Exception e) {
